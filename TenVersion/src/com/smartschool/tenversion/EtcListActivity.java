...
public class EtcListActivity extends Activity  implements OnClickListener{
	private static final String TAG ="EtcListActivity";
	/**  UI  **/
	//String
	 String allDelSelectTxt ;
	 String allDelDeselectTxt;
	private static final int MODE = 3; //etc
	private static final String etcMode="3"; //etc
	private boolean DEL_MODE = false; 
	private boolean ALL_DEL_MODE = false; 
	//setListView 
	private ListView etcListView = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       if(DEL_MODE){ 
        ...
        //listView
        etcListView = (ListView)findViewById(R.id.listView);
    ...
    public void updateListview(){
    	...
    	checkListItem.clear();
    	mDBcursor = mDBHandler.selectAllList(etcMode);//mode = safe = 1
		...
		etcListView.setAdapter(checkListAdapter);
    }
